...
//console.log("Números randômicos : " + (Math.round(Math.random()*100))) //aparece o 0

function alteraDiv(){
    document.getElementById("quadro-cores").style.backgroundColor = "purple"
    ...
    //UNINDO VALORES COM INTERPOLAÇÃO
    document.getElementById("quadro-cores").style.backgroundColor = `rgb(${r},${g},${b})`
}

//setTimeout(alteraDiv, 3000)
setInterval(alteraDiv, 1500)